...
::  Below code also works for ARM64 Windows 10-11 (including x64 bit emulation)
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Create By ROHIT ABDULLAH"
echo:            ___________________________________________________ 
echo:
echo:               Find me on:
echo:                     Github    : https://github.com/rohitabdullah
echo:                     Telegram  : https://t.me/iamanonymous_004
echo:                     Facebook  : https://facebok.com/rohit.abdullah.5
echo:                     Instagram : https://instagram.com/rohit_abdullah.5
echo:
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate
echo:               [2] Freeze Your Trial Period
echo:               [3] Reset Current Activation / Trial
...
echo %line%
echo:
call :_color %Green% "The IDM Trail reset process has been completed."
...
echo:
if not exist "%IDMan%" (
call :_color %Red% "IDM [Internet Download Manager] is not Installed Bro!!.Go and install it first."
...
echo:
if %frz%==0 (
call :_color %Green% "The IDM Activation was successful Now Go and Chill!."
echo:
